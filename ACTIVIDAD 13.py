...
class mensajes:
    ...
    def estadisticas(self):
        ...
        max_repartidores=[r.nombre for r in self.repartidores if r.paquetes == max_entrega]
        min_repartidores = [r.nombre for r in self.repartidores if r.paquetes == min_entrega]
...
nombre_buscar = input("\nBuscar repartidor: ")
encontrado = empresa.buscar(nombre_buscar)
if encontrado:
    print(encontrado)
else:
